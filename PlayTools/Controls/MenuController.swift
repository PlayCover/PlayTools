...
var macros = ["Start/Stop touch recording",
              "Start/Stop replaying",
              "Loop/Stop replaying"]
var macroSelectors = [#selector(UIViewController.switchTouchRecording(_:)),
                      #selector(UIViewController.switchTouchReplaying(_:)),
                      #selector(UIViewController.switchTouchReplayingLoop(_:))]
